...
\begin{tikzpicture}[>=stealth,scale=1.0,font=\small]
  ...
  \draw[gray] (0,-1)--(0.3,-1) node [right=-0.08] {纸带} ;
  \draw[gray] (0,-3.05)--(0.3,-3.05) node [right=-0.08] {夹子} ;
  \draw[gray] (0,-3.65)--(0.3,-3.65) node [right=-0.08cm] {重物} ;
  \draw[gray] (-1,-1.7) node [above=-0.08] {打点计时器} --(-0.7,-2)  ;
  \draw [gray] (-1,-3.7)..controls(-1.3,-3) and (-1.5,-3.3)..(-1.1,-2.6);
  \draw [gray] (-1.3,-3.7) node [below right=-0.08] {接电源} ..controls(-1.6,-3) and (-1.8,-3.3)..(-1.1,-2.2) ;
\end{tikzpicture}
\end{document}