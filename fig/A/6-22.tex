...
\begin{tikzpicture}[>=stealth,scale=0.9]
  ...
  \draw [very thick, ->] (30:4)--(30:4-.75)node[above left]{$F_1$};
  \draw [dashed] (30:4-.75)--(2*1.732, 2+.75);
  \draw (.7,0) arc (0:30:.7) node[midway,above right,yshift=-3.5]{\ang{30}};
  \draw (2*1.732-2/1.732+.5,0) arc (0:60:.5) node[midway,right,yshift=1.5]{\ang{60}};
