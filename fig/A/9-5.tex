...
\begin{tikzpicture}[>=stealth,thick,scale=0.9]
  ...
  \draw (-3.5,-.5) arc (270:285:.5) node [left=0.15cm]{$\theta_1$};
  \draw (.5,-.5) arc (270:255:.5) node [right=0.15cm]{$\theta_1$};
  ...
  \begin{scope}[yshift=-4.5cm]
    ...
    \draw (-3.5,-.5) arc (270:245:.5) node [right=0.2cm]{$\theta_2$};
    \draw (.5,-.5) arc (270:295:.5) node [left=0.2cm]{$\theta_2$};
