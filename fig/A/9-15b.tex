...
\begin{tikzpicture}[>=stealth,xscale=0.7,yscale=0.8,samples=200]
  ...
  \begin{scope}[yshift=-15cm]
    ...
    \draw[thin] (1,0.4)--(1,-2)(13,0.4)--(13,-2);
    \draw[thin,<->](1,-1.8)--(13,-1.8)node[midway,above]{$\lambda$};
    \draw[thin] (2,0.06)--(2,-2.5)(14,0.06)--(14,-2.5);
    \draw[thin,<->](2,-2.3)--(14,-2.3)node[midway,above]{$\lambda$};
  \end{scope}
