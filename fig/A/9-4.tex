...
\begin{tikzpicture}[>=stealth,thick,scale=0.9]
  ...
  \draw (-3.5,-.7) arc (270:285:.7) node [left=0.15cm] {$\theta_1$};
  \draw (.5,-.7) arc (270:255:.7)   node [right=0.15cm]{$\theta_1$};
  ...
  \begin{scope}[yshift=-4.5cm]
    ...
    \draw (-3.5,-.7) arc (270:290:.7) node [left=0.2cm]{$\theta_2$};
    \draw (.5,-.7) arc (270:250:.7)   node [right=0.2cm]{$\theta_2$};
    \draw [<-](-3.5,-3.25) arc (270:285:3.25);
    \draw [<-](.5,-3.25) arc (270:255:3.25);
    \draw [->](-1.5,-3.25)--(-2,-3.25);
    \draw [<-](3,-3.25)--(2.5,-3.25);
