...
\begin{tikzpicture}[>=latex,scale=1.0]
  ...
  \draw[very thin,|<->|](-0.55,1.7)--(-0.55,2.7)node[midway,left]{$h$};
  \draw[double distance=2pt,double=gray!40!black](-0.25,2.7)--(-0.25,0.5)arc(180:360:0.25)--(0.25,1.7);
  \draw[double distance=2pt,rounded corners=7pt](-0.25,2.7)--(-0.25,4.2)--++(-0.5,0);
  \draw[double distance=2pt,rounded corners=7pt](0.25,1.7)--(0.25,4.3);
