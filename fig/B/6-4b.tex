...
\begin{tikzpicture}[>=latex,scale=1.5]
  ...
  \draw[thin,densely dashed](O)--(A)node[midway,above left]{$r_1$};
  \draw[thin,densely dashed](O)--(B)node[midway,above left]{$r_2$};
  \draw[thin,densely dashed](O)--(C)node[midway,above right]{$r_3$};
\end{tikzpicture}
\end{document}