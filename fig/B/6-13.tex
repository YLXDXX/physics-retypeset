...
\begin{tikzpicture}[>=latex,scale=1.2]
  ...
  \draw(0,0.62)--(0,1.0);
  \draw(0,0.3)--(0,0);
  \draw[very thin](0,0)--(250:0.2)(0,0)--(290:0.2);
  ...
  \node at (0.35,1.2) {$C$};
  \end{scope}
  \draw[densely dashed,<-] (0,1.0) to[bend left=30] (1.8,1.2);
  \fill[left color=brown,right color=brown,middle color=white](0.98,1.4)rectangle(1.02,1.7);
  \fill[ball color=gray](1.0,1.38)circle(0.07)node[below=1mm]{$e$};
\end{tikzpicture}
\end{document}