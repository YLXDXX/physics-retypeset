...
\begin{tikzpicture}[>=latex]
  ...
  \def\Q{-1}
  \def\R{1.0}
  \def\range{1.4,1.6,1.8,1.9,1.99}
  ...
  \begin{scope}[yshift=4cm]
    \EFieldLines
  \end{scope}
  \fill[white](-1,0)rectangle(1,4);
  \foreach \x in {0.1,0.3,...,3.9}
    {
      \draw[densely dashed,->,orange!80!black](-1,\x)--(-0.15,\x);
      \draw[densely dashed,->,orange!80!black](-0.15,\x)--(0.25,\x);
      \draw[densely dashed,orange!80!black](0.25,\x)--(1,\x);
    }
  \fill[rounded corners=2pt,left color=red!50,right color= red!50,middle color=red!10](-1.1,-0.1)rectangle(-0.9,4.1);
  \fill[rounded corners=2pt,left color=blue!50,right color= blue!50,middle color=blue!10](1.1,-0.1)rectangle(0.9,4.1);
  
  \foreach \x in {0.2,0.6,1.0,...,4}
  {
  		\node [black,font=\tiny] at (+\a,\x)  {$-$};
  		\node [black,font=\tiny] at (-\a,\x) {$+$};
  }
