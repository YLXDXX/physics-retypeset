...
\begin{tikzpicture}[>=latex,scale=1.3]
  \eye{scale=2}
  \draw[densely dashdotted](-0.5,0)--(-5.5,0);
  \draw[fill=cyan!20!white](-1,0.5)to[bend right=15](-1,-0.5)to[bend right=15](-1,0.5)node[above]{$L_2$}--cycle;
  \draw[fill=cyan!20!white](-5,0.8)to[bend right=15](-5,-0.8)to[bend right=15](-5,0.8)node[above]{$L_1$}--cycle;
  \fill(-1.620,-0.050)--(-1.620, 0.150)--(-1.580, 0.150)--(-1.580,-0.050)--(-1.560,-0.050)--(-1.600,-0.150)--(-1.640,-0.050)--cycle;
  \draw[densely dashed](-2.586,-0.136)--(-2.586, 0.410)--(-2.477, 0.410)--(-2.477,-0.136)--(-2.423,-0.136)--(-2.532,-0.409)--(-2.641,-0.136)--cycle;
  \fill(-1.7,0)circle(0.7pt);
  % \draw(-3.8,-0.9)--(0,0.15);
  % \draw(-3.8,-0.9)--(0,-0.2);
  \draw[densely dashed](-2.5319,-0.4085)--(-1,-0.0706)(-2.5319,-0.4085)--(-1,-0.1765)(-2.5319,-0.4085)--(-1,-0.2824);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-1,-0.0706)--(0,0.15);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-1,-0.1765)--(0,-0.025);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-1,-0.2824)--(0,-0.2);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-5,-0.6)--(-1,-0.0706);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-5,0)--(-1,-0.1765);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-5,0.6)--(-1,-0.2824);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrowreversed{>}}}](-5,-0.6)--++(-1,0.043);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrowreversed{>}}}](-5,   0)--++(-1,0.043);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrowreversed{>}}}](-5, 0.6)--++(-1,0.043);
  \node at (-1.6,-0.15)[below=1mm]{$A'$};
  \node at (-1.6,0.15)[above]{$B'$};
  \node at (-2.532,-0.4085)[below]{$A''$};
  \node at (-2.532,0.4095)[above]{$B''$};
\end{tikzpicture}
\end{document}