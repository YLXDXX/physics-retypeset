...
\begin{tikzpicture}[>=latex]
  ...
  \eye{xshift=3.5cm}
  \fill[pattern= north east lines](A)rectangle([xshift=-0.25cm]B);
  \draw[thick](A)--(B);
  \draw[thin,densely dashdotted](A)--++(1.0,0)(B)--++(1.0,0)(3.0,0)--(0,0);
  \draw [postaction ={decorate},decoration={markings,mark={between positions 0.25 and 0.8 step 0.5 with {\arrowreversed{>}}}}]([shift=(-10:3.5)]B)--(B)--++(10:2.879);
  \draw [postaction ={decorate},decoration={markings,mark={between positions 0.25 and 0.8 step 0.5 with {\arrowreversed{>}}}}]([shift=(10:3.5)]A)--(A)--++(-10:2.879);
  \draw[-stealth,thin]([shift=(-10:3.0)]B)arc(-10:10:5.879);
  \end{scope}
  \begin{scope}[xshift=6cm]
    \coordinate (A) at (0,0.5);
    \coordinate (B) at (0,-0.5);
    \eye{xshift=3.5cm}
  \fill[pattern= north east lines](A)arc(5:-5:5.737)--++(175:0.25)arc(-5:5:5.487);
  \draw[thick](A)arc(5:-5:5.737);
  \draw[thin,densely dashdotted](A)--++(5:1.0)(B)--++(-5:1.0)(3.0,0)--(0,0);
  \draw [postaction ={decorate},decoration={markings,mark={between positions 0.25 and 0.8 step 0.5 with {\arrowreversed{>}}}}]([shift=(-20:3.5)]B)--(B)--++(10:2.879);
  \draw [postaction ={decorate},decoration={markings,mark={between positions 0.25 and 0.8 step 0.5 with {\arrowreversed{>}}}}]([shift=(20:3.5)]A)--(A)--++(-10:2.879);
  \draw[-stealth,thin]([shift=(-20:3.0)]B)arc(-20:20:4.462);
  \end{scope}
\end{tikzpicture}
\end{document}