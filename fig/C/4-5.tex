\documentclass[margin={0 2 0 2}]{standalone}
\usepackage{tikz}
...
\begin{tikzpicture}[>=latex,scale=1.2]
  ...
  \draw[red6,](0,1.7)--++(-2,0);
  \draw[red6,postaction={decorate},decoration={markings,mark={at position 0.5 with {\arrow{>}}}}](-2,1.7)--++(0,-2.7)node[pos=0.5,left
  ,text=black]{$i$};
  \draw[red6](-2,-1)--++(2,0);
