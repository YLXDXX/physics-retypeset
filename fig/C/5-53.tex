...
\begin{document}
\small
\begin{tikzpicture}[>=latex,scale=0.89]
  \useasboundingbox(-2.6,-0.1)rectangle(2.6,8.2);
  \eye[90]{yshift=7.6cm,scale=1.8}
  \draw[densely dashdotted](0,0.2)--(0,7.5);
  \draw[fill=cyan!20!white](0.7,5.6)to[bend right=15](-0.7,5.6)to[bend right=15](0.7,5.6)node[right]{$L_2$}--cycle;
  \draw[fill=cyan!20!white](0.5,1.1)to[bend right=15](-0.5,1.1)to[bend right=15](0.5,1.1)node[right]{$L_1$}--cycle;
  \fill(0,0.5)circle(1pt);
  \fill(0,4.2)circle(1pt)node[above]{$F_2$};
  \draw(0,0.5)--++(0.3,0)node[right]{$F_1$};
  \draw[thin,arrows={-Stealth[scale=0.5]}](0.08,0.38)node[below right,inner sep=1pt]{$A$}--(-0.08,0.38)node[below left,inner sep=1pt]{$B$};
  \draw[->](-0.4,4.7)node[below left,inner sep=1pt]{$A'$}--(0.4,4.7)node[below right,inner sep=1pt]{$B'$};
  \draw[ultra thick,dashed,->](-2,0)node[above left,inner sep=1pt]{$A''$}--(2,0)node[above right,inner sep=1pt]{$B''$};
  \draw[thin,densely dashed](-2,0)--(-0.6,5.6)(-2,0)--(-0.5,5.6)(-2,0)--(-0.4,5.6)(2,0)--(0.6,5.6)(2,0)--(0.5,5.6)(2,0)--(0.4,5.6);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.3 with {\arrow{>}}}](-0.6,5.6)--(-0.1333,7.4667);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.3 with {\arrow{>}}}](-0.5,5.6)--(0,7.4667);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.3 with {\arrow{>}}}](-0.4,5.6)--(0.1333,7.4667);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.3 with {\arrow{>}}}](0.6,5.6)--(0.1333,7.4667);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.3 with {\arrow{>}}}](0.5,5.6)--(0,7.4667);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.3 with {\arrow{>}}}](0.4,5.6)--(-0.1333,7.4667);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-0.4,1.1)--(0.6,5.6);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](0,   1.1)--(0.5,5.6);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}]( 0.4,1.1)--(0.4,5.6);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}]( 0.4,1.1)--(-0.6,5.6);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](0,   1.1)--(-0.5,5.6);
  \draw[postaction={decorate},decoration={markings,mark=at position 0.5 with {\arrow{>}}}](-0.4,1.1)--(-0.4,5.6);
  \draw(0.08,0.38)--(-0.4,1.1);
  \draw(0.08,0.38)--(0,   1.1);
  \draw(0.08,0.38)--( 0.4,1.1);
  \draw(-0.08,0.38)--( 0.4,1.1);
  \draw(-0.08,0.38)--(0,   1.1);
  \draw(-0.08,0.38)--(-0.4,1.1);
