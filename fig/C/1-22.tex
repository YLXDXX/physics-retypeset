...
\begin{tikzpicture}[>=latex,scale=1.1]
  ...
  \begin{scope}%[xscale=-1]
    ...
    \node at (2.3,0.6)[above right]{$B$};
    \draw[shading=pile,shading angle=30,very thin](0.034,0.456)--(2.199,1.706)arc(120:-60:0.05)--(0.084,0.370)--cycle;
    \draw[fill=lightgray,very thin](0.0594,0.4132)circle(0.05);
    \draw[->](1.065,1.052)--++(170:0.5)node[left]{$F$};
